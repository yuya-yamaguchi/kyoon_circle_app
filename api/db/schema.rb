...
ActiveRecord::Schema.define(version: 20_210_215_120_343) do
  ...
  create_table 'user_entry_parts', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4', force: :cascade do |t|
    ...
    t.index %w[user_id session_part_id], name: 'index_user_entry_parts_on_user_id_and_session_part_id', unique: true
